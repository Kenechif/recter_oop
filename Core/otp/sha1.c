...
//  memcpy(statee.b,sha1InitState,HASH_LENGTH);
//  byteCount = 0;
//  bufferOffset = 0;
//}
//
...
//  for (i=0; i<80; i++) {
//    if (i>=16) {
//      t = bufferr.w[(i+13)&15] ^ bufferr.w[(i+8)&15] ^ bufferr.w[(i+2)&15] ^ bufferr.w[i&15];
//      bufferr.w[i&15] = rol32(t,1);
//    }
//    if (i<20)
//    {
//      t = (d ^ (b & (c ^ d))) + SHA1_K0;
...
//}
//
//__WRITE_RESULT write1(uint8_t data) {
//  ++byteCount;
//  addUncounted(data);
//
//  __WRITE_RETURN(1);
