 ...
 //				send_line3("      ");
  ...
  //==========================================================================
   else if ( (auth == authed) && ( (access == level2)||(access == level3) ) && (fxn == setnozzle)  )
   {
	   ...
	   {
			//send_line1();
		  if(copy_stream1[pump_indx-1].noz == overide)
		  {
			send_line2("Active");
		  }
		  else
		...
		if ( (rd19 == 1)&&( key19_sto_ == 0) )
		 ...
		 if( (pkey > 0) )  //key detected
		 {
			 if (pkey == 'B')  // up key
				{
				 if (copy_stream1[pump_indx-1].noz == overide)
					 copy_stream1[pump_indx-1].noz = nooveride;
				 else
					 copy_stream1[pump_indx-1].noz = overide;
				}
 ...
 //				 clr_screen1();
  ...
  //======================================================================
   ...
   else if ( (auth == authed) && ( (access == level2)||(access == level3) ) && (fxn == setaddress)  )
   {
	   if (t >= 500)
	   {
			printDisp_i(copy_stream1[pump_indx-1].id_, 1, 0, 4, RT, CLEAR);
			 ...
			 if (pkey == 'D')  //enter key
				{
					 if (pump_indx == 1)   // if side A
					 {
					   if(ln_ == 1) copy_stream1[0].dp_price  = dp_;
					   if(ln_ == 2) copy_stream1[0].dp_amount = dp_;
