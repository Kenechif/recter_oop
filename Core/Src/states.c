    	   ...
    	   if (pkey == 'D') // enter key...
    	   {
              //password provided...  settings[0].passwd1
			   long int pass_ = atol(keypad_buf);
				   ...
				   else if(pass_ == password_level2 )  //level 3 access ?
				   {
					  auth = authed;
					  access = level2;
					  fxn = nothing;
...
//						if (pkey == 'B')  // down key
 ...
 /*   //check keypad for pressed xter
  	   ...
  	   if (t >= 500)
  		 {
			  ...
			  //=======================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == setmode)  )
   {
	   if (t >= 300)
		 {
			//send_line1();
	...
	key19_sto_ = rd19;
	 ...
	 return prog_State;
	  ...
	  //                set mode   OVERIDE.
	  //==========================================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == setnozzle)  )
   {
	   if (t >= 300)
	   {
			//send_line1();
	 ...
	 return prog_State;
		  ...
		  //======================================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == default_sell_type)  )
   {
	   if (t >= 300)
		 {
			//send_line1();
	 ...
	 return prog_State;
		  ...
		  //               set the  litre price
		  //=====================================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == setprice) )
   {
	 if (t >= 300)
	  {
	 ...
	 return prog_State;
			     ...
			     //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
				  ...
				  //                          ID SETTINGS.
				  //=====================================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == setaddress)  )
   {
	   if (t >= 500)
	   {
  ...
  //                         SET MAX AMOUNT.
  //=====================================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == setmax_amt)  )
   {
	   if (t >= 500)
	   {
...
/*
  ...
  //                         SET PASSWORD
  //====================================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == set_password)  )
    {
	   static int chg_pw = 0;
	   static int pw1 = 0;
	   static int pw2 = 0;
    ...
    //                        CALIBRATE..
    //====================================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == calibrate_)  )
     {
...
//                      display precision
//=====================================================================
   else if ( (auth == authed) && (access == level1)&&(fxn == display_)  )
   {
 ...
 //               set the  CLOCK
 //=====================================================================
   	 else if ( (auth == authed) && (access == level1) && (fxn == setclock) )
	 {
