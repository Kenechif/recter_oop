...
float key_value CCRAM = 0.0,
	  key_value_original1 CCRAM = 0.0;

float price_real1,
	  amt_real1 CCRAM = 0.0;
float amt_ CCRAM = 0.0,
	  price_;
...
sStateEventMachine asStateEventMachine_1 [] =
{
	...
	{idle_State, idleState_Handler, {_operator_Event, _keyup_Event,_tot_error_Event, _keypress_Event, _nozzleup_Event, _auth_command_Event, _nozzledown_Event, _resetcommand_Event, _switchoffcommand_Event, _tone_Event, _filling_resumecommand_Event}},
...
//	resetTimer_tone1(TONE_DURATION);
	startTimer_tone1(tone_duration1);
...
eSystemState filling_resumecommand_Handler(void)
{
	 	 ...
	 	 current_pulser1 = ( currentPulser_recovered1 + current_pulser1);
	...
	amt = pulser2amt(current_pulser1);

	price = amt2price(amt);

	amt_middle1_tmin3 = amt;
	amt_middle1_tmin2 = amt;
	amt_middle1_tmin1 = amt;
	amt_middle1 = amt;
...
//		calibration_flag1 = CALIBRATED;
	...
	if(fillingresume_flag1_1 == 1)
	{
		amt = pulser2amt(currentPulser_recovered1);
...
//======================== @ filling1 =============================
	  // get_time2();
	   ...
	   amt_real1_tmin3 = amt_real1_tmin2;
	   amt_real1_tmin2 = amt_real1_tmin1;
	   amt_real1_tmin1 = amt_real1;
	   ...
	   amt_real1_array[0] = amt_real1;
	   amt_real1_array[1] = amt_real1_tmin1;
	   amt_real1_array[2] = amt_real1_tmin2;
	   amt_real1_array[3] = amt_real1_tmin3;

		correctArray1(amt_real1_array, amt_a);

		amt_real1 = amt_real1_array[0];
		amt_real1_tmin1 = amt_real1_array[1];
		amt_real1_tmin2 = amt_real1_array[2];
		amt_real1_tmin3 = amt_real1_array[3];
...
void make_string(sellmode_ sll, float pr)
{
	...
	char ttmp[10] = {0};
	 ...
	 if (sll == L)
	 {
		 ...
		 amt_middle1_tmin3 = amt_middle1_tmin2;
		 amt_middle1_tmin2 = amt_middle1_tmin1;
		 amt_middle1_tmin1 = amt_middle1;
...
//		 amt_middle1 += 0.00011;
		 amt_middle1 = strtof(temp, &endPtr);
 		 ...
 		 amt_middle1_array[0] = amt_middle1;
		 amt_middle1_array[1] = amt_middle1_tmin1;
		 amt_middle1_array[2] = amt_middle1_tmin2;
		 amt_middle1_array[3] = amt_middle1_tmin3;

		 correctArray1(amt_middle1_array, amt_a);

		 amt_middle1 = amt_middle1_array[0];
		 amt_middle1_tmin1 = amt_middle1_array[1];
		 amt_middle1_tmin2 = amt_middle1_array[2];
		 amt_middle1_tmin3 = amt_middle1_array[3];
