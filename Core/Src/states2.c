...
uint32_t target_pulser2 , current_pulser2 = 0;
...
extern float price_real,amt_real;
					  ...
					  if(indxx1 == 1)
					  {
						  ...
						  if( res > 8)  //if lenght of the number > 8
							 ...
							 else
							 {
								 send_line12("l        ");
								 send_line22("        ");
								 printDisp_f2(totaliser_vol1c, 2, 0,5,RT,CLEAR ); //send_line2(scc);
							 }
						  send_line32("tot A");
					   }  //  if (indx1 == 1)
					   ...
					   else if(indxx1 == 2)
					   {
						  ...
						  if( res > 8)  //if lenght of the number > 8
							 ...
							 else
							 {
								 send_line12("p        ");
								 send_line22("        ");
								 printDisp_f2(totaliser_amt1c, 2, 0,5,RT,CLEAR ); //send_line2(scc);
							 }
						  send_line32("tot A");
					   }  //  if (indx1 == 1)
				   }
					 ...
					 if(indxx1 == 1)
					 {
						...
						if( res > 8)  //if lenght of the number > 8
						 ...
						 else
						 {
							 send_line12("l        ");
							 send_line22("        ");
							 printDisp_f2(totaliser_vol2c, 2, 0,5,RT,CLEAR ); //send_line2(scc);
						 }
					  send_line32("tot B");
					 }  //  if (indx1 == 2)
					 ...
					 else if (indxx1 == 2)
					 {
						...
						if( res > 8)  //if lenght of the number > 8
						 ...
						 else
						 {
							 send_line12("p        ");
							 send_line22("        ");
							 printDisp_f2(totaliser_amt2c, 2, 0,5,RT,CLEAR ); //send_line2(scc);
						 }
					  send_line32("tot B");
					 }  //  if (indx1 == 2)
				   }
...
//							  {
								 ...
								 else if (scroll_ == 2)
								 {
								  ...
								  {
									  char st__[10]= {0};
									  snprintf(st__, sizeof(st__),"%d%02d hrs",log_b_new.time._hh,log_b_new.time._mn);
									  printDisp_c2(st__,2,0,8,LT,CLEAR);
								  }
	  ...
	  if(pkey > 0)  //key detected
	   {
    	   if (pkey == 'D') // enter key...
    	   {
              //password provided...  settings[0].passwd1
			   long int pass_ = atol(keypad_buf2);
        ...
        //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
          ...
          //====================================================================
             if ( (auth2 == authed) && (access == level1)&&(fxn == nothing)  )
               {
				   if (t2 >= 500)
					 {
					    if(indx_m == 15) indx_m = 14;
						send_line12(menu2[indx_m]);   //show menu item.
						send_line22("        ");
						t2 = 0;
					 }
                 // -------------- test keys....----------------
...
//          						if (indx_m > 0) indx_m--;
 ...
 /*   //check keypad for pressed xter
  	   ...
  	   if (t >= 500)
  		 {
			  ...
			  //=======================================================
             if ( (auth2 == authed) && (access == level1)&&(fxn == setmode)  )
  	               {
  					   if (t2 >= 300)
  						 {
  							//send_line1();
	  ...
	  //                set mode   OVERIDE.
	  //==========================================================================
		 if ( (auth2 == authed) && (access == level1)&&(fxn == setnozzle)  )
		   {
			   if (t2 >= 300)
				 {
					//send_line1();
		  ...
		  //======================================================================
			 if ( (auth2 == authed) && (access == level1)&&(fxn == default_sell_type)  )
				   {
					   if (t2 >= 300)
						 {
							//send_line1();
		  ...
		  //               set the  litre price
		  //=====================================================================
			 if ( (auth2 == authed) && (access == level1)&&(fxn == setprice) )
			   {
				 if (t2 >= 300)
				  {
			     ...
			     //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
				  ...
				  //                          ID SETTINGS.
				  //=====================================================================
					 if ( (auth2 == authed) && (access == level1)&&(fxn == setaddress)  )
					   {
						   if (t2 >= 500)
							 {
	  ...
	  //                         SET NO FLOW TIME.
	  //==========================================================================
		 if ( (auth2 == authed) && (access == level1)&&(fxn == set_no_flow_time)  )
		   {
			   if (t2 >= 500)
				 {
				   printDisp_i2(copy[pump_indx-1].noflow_, 1, 0, 4, RT, CLEAR);
				   send_line22(keyboard_entry2);
					 ...
					 if (pkey == 'D')  //enter key
						{
							 if (pump_indx == 1)   // if side A
								{
								   copy[0].noflow_ =  atoi(keyboard_entry2);
								}
							 if (pump_indx == 2)   // if side b
								{
								   copy[1].noflow_ =  atoi(keyboard_entry2);
								}
						}
  ...
  //                         SET MAX AMOUNT.
  //=====================================================================
	 if ( (auth2 == authed) && (access == level1)&&(fxn == setmax_amt)  )
	   {
		   if (t2 >= 500)
			 {
...
//============================== MODE ==================================
 ...
 //                         CLEAR LOG.
 //=====================================================================
 if ( (auth2 == authed) && (access == level1)&&(fxn == clr_log_)  )
   {
	   if (t2 >= 500)
		 {
...
//				}
 ...
 //=====================================================================
  //                         CLEAR totaliser.
  //=====================================================================
  if ( (auth2 == authed) && (access == level1)&&(fxn == clr_tot_)  )
    {
 	   if (t2 >= 500)
 		 {
 		   //printDisp_i(copy[pump_indx-1].max_amt_, 1, 0, 4, RT, CLEAR);
// 		   send_line2(keyboard_entry2);
...
// 				}
 ...
 //                         SEND CONFIG.
 //=====================================================================
 if ( (auth2 == authed) && (access == level1)&&(fxn == send_config)  )
   {
	   if (t2 >= 500)
		 {
		   //printDisp_i(copy[pump_indx-1].max_amt_, 1, 0, 4, RT, CLEAR);
...
/*
  ...
  //                         get config
  //=====================================================================
  if ( (auth2 == authed) && (access == level1)&&(fxn == get_config)  )
    {
 	   if (t2 >= 3000)
 		 {
  ...
  //                         SET PASSWORD
  //====================================================================
  if ( (auth2 == authed) && (access == level1)&&(fxn == set_password)  )
    {
	   static int chg_pw = 0;
	   static int pw1 = 0;
	   static int pw2 = 0;
	   ...
	   if(prog_revisit2 == 1)
	   {
 	   ...
 	   if (t2 >= 500)
 		 {
 		    send_line12(keypad_pw_xter2); //keyboard_entry);
 		    send_line22("  Enter ");
		    send_line32("Pass. ");
 		   if (pump_indx == 1)
 		  		 {
    ...
    //                        CALIBRATE..
    //====================================================================
    if ( (auth2 == authed) && (access == level1)&&(fxn == calibrate_)  )
      {
...
//                      display precision
//=====================================================================
 if ( (auth2 == authed) && (access == level1)&&(fxn == display_)  )
 {
	 if(enter_key == 1)
	 {
 ...
 //=========================== MODE ====================================
  ...
  //               set the  CLOCK
  //=====================================================================
 	 if ( (auth2 == authed) && (access == level1) && (fxn == setclock) )
 	 {
...
//	current_pulser_ = __HAL_TIM_GET_COUNTER(&htim2);
...
//		if( ! ( (eNextState2 == idle_State) && (eLastState2 == idle_State) ) )
		...
		else //if( (eNextState2 == idle_State) && (eLastState2 == idle_State) )
		{
			...
			&& (flow_loss2 == 0) && (display_overflow2 == 0) && (changeLitrePrice2_2 == 0) && (_pump_max_litres2 == 0) )
	{
		 send_line12(upper2);
		 send_line22(middle2);
		 send_line32("        ");
...
// snprintf(str_, sizeof(str_), "%.2f", amt);   send_line2(str_);
 ...
 send_line22("        ");
 char str__[8]= {0};
 snprintf(str__, sizeof(str__), "%.2f", litre_price2); send_line2(str__);
...
//		  }
		  ...
		  else if (index_2 >= 1)
		  {
			  ...
			  //initialise the fuel and price variables
				...
				{
					if( (key_value2 > pump_max_litres1) || (key_value2 > sellPrice_max_dpp) )
					{
						if(pump_max_litres2 < sellPrice_max_dpp)
						{
							key_value2 = pump_max_litres2;
...
//============================================================================
	  ...
	  price2  = 0.0;
		 ...
		 // int cnv = 0;
	     //char temp[10] = {0};
		 //snprintf(temp , sizeof(temp), "%.2f", price);  //send_line1(upper1);
         //snprintf(middle1, sizeof(middle1), "%.2f", amt);   //send_line2(lower);
...
//  	}
//
//  r_volTotaliser = floor( working_volTotaliser1c );
...
//--------------
eSystemState filling_paused_State_Handle2r(void)
{
       return filling_paused_State;
}
...
eSystemState timeout_Handler2(void)
{
	 if(eLastState1 != authorised_nozzleup_State)
	 {
	  ...
	  else if(eLastState1 == nozzleup_waitingforauth_State)
	  {
		 send_line32("err1 ");
		 nozzleup_awaitingauth_state_not_timedOut2 = 0;
	  }

	  else if(eLastState1 == authorised_nozzledown_State)
	  {
		 send_line32("err2 ");
	  }

	  else if(eLastState1 == authorisation_paused_State)
	  {
		 send_line32("err3 ");
	  }

	  else if(eLastState1 == filling_paused_State)
	  {
		 send_line32("err4 ");
	  }

	  else if(eLastState1 == authorised_nozzleup_State)
	  {
		 if( ((pump_LitreOverflow2 == 1) && (pulser_rem2 > 0 )) || ((display_overflow2 == 1) && (pulser_rem2 > 0 )) )
		 {
			  if(pump_LitreOverflow2 == 1)
...
//--------------------------------------------------------------------
      ...
      if ( (kkey2 == 'A')&&(progg2 == 0)&&(eNextState2 == filling_State) ) //stop sales.
    	 	{
               stop_flag2 = 1;  //activate auth cmd.
    	 	}
...
//======================== @ filling =============================
	  // get_time2();
	   ...
	   amt2 = dp2(temp,dp_amount2);

	   temp = amt2price2(amt2);
	   price2 = dp2(temp,dp_price2);
...
//		price_real2 = dp2(temp,dp_price2);
	    ...
	    make_string2(P,dp2(price2,dp_price2));
	    make_string2(L,dp2(amt2,dp_amount2));
	    //send_line1(upper1);
	    //send_line2(middle1);
	       ...
	       //---------------------------------------------------------
	    	...
	    	//amt   = dp( price_/litre_price ,dp_amount);
			 ...
			 temp = amt2price2(amt2);
	   		 ...
	   		 price_2 = dp2(key_value2,dp_price2);
	   		 	 temp = price_2/litre_price2;
	   		 amt_2   = dp2(temp,dp_amount2); //calculate vol frm price.
	   	 ...
	   	 //------------------------------------------------------------------
	   	  make_string2(P,dp2(price_2,dp_price2));
	   	  make_string2(L,dp2(amt_2,dp_amount2));
...
//	   	   if(operating_side == side_a)
//	   	   {
//	   		   totaliser_vol1 = running_volTotaliser2;    // update totaliser
//	   		   totaliser_vol1c = running_volTotaliser2c;  // update totaliser
//	   	   }
//	   	   else
//	   	   {
...
//	   	   }
   ...
   else
   {
      //programmed but still dispensing @ stop pt.
		 temp = pulser2amt2(current_pulser2);  amt2   = dp2(temp,dp_amount2);
		 temp = amt2price2(amt2);   			price2 = dp2(temp,dp_price2);
 ...
 else   // if target_pulser == 0
 {
     ...
     //still dispensing @ stop pt.
		...
		//compare the final and initial prices...
		 	 float ddp = 0;
		 	 if (dp_price2 == 1) ddp =  0.1;
			 else if (dp_price2 == 2) ddp =  0.01;
			 else if (dp_price2 == 3) ddp =  0.001;
...
void state_ini2(void)
{
	...
	irrecov_flag2 = 0;
	progg2 = 0;
	eNextState2 =  idle_State; //   prog_State; //
...
//	stop_flow2();
	...
	write_v2(1, "p        ");  send_line12("p        ");
	write_v2(2, "l        ");  send_line22("l        ");

    temp = amt2price2(lastVolumeSale2c);
	price2 = dp2(temp, dp_price2);
    make_string2(P, dp2(price2, dp_price2) );
...
void states2(void)
{
	...
	eSystemEvent ev2;
	  ...
	  /*
	if((eNextState1 < last_State) && (eNewEvent < last_Event)&& (asStateMachine[eNextState1].eStateMachineEvent == eNewEvent) && (asStateMachine[eNextState1].pfStateMachineEvnentHandler != NULL))
		{
